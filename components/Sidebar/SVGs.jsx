export const feedSVG = (
  <svg
    ...
    className='icon icon-tabler icon-tabler-shape h-6 w-6'
    viewBox='0 0 24 24'
    strokeWidth='1.5'
    stroke='currentColor'
    fill='none'
...
export const userSVG = (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className='icon icon-tabler icon-tabler-user h-6 w-6'
    viewBox='0 0 24 24'
    strokeWidth='1.5'
    stroke='currentColor'
    fill='none'
...
export const communitySVG = (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className='icon icon-tabler icon-tabler-users h-6 w-6'
    width='40'
    height='40'
    viewBox='0 0 24 24'
    strokeWidth='1.5'
